...
public class PackageDataUtils {
	...
	public static void read(final File file, final PackageInfo packageInfo) throws PackageInfoException {
		...
		String name = (String) groovyObject.getProperty("name");
		String version = (String) groovyObject.getProperty("version");
		String slot = (String) groovyObject.getProperty("slot");
		String url = (String) groovyObject.getProperty("url");
