...
public interface Provider {
	...
	void add(final File file) throws RepositoryAddException, RepositoryAccessException;
	void commit(final File file, final String message) throws RepositoryCommitException, RepositoryAccessException;
}
